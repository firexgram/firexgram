        ...
        if (messageOwner instanceof TLRPC.TL_messageService) {
            ...
            if (!TextUtils.isEmpty(restrictionReason)) {
                ...
                if (messageOwner.media instanceof TLRPC.TL_messageMediaDice) {
                    ...
                    messageText = LocaleController.getString("UnsupportedMedia", R.string.UnsupportedMedia).replace("https://telegram.org/update","https://github.com/nift4/Telegram/releases/latest");
